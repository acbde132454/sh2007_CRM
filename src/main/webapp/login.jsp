			...
			<form action="/crm/settings/user/login" class="form-horizontal" method="post" role="form">
				<div class="form-group form-group-lg">
					<div style="width: 350px;">
						<input name="loginAct" class="form-control" type="text" placeholder="用户名">
					</div>
					<div style="width: 350px; position: relative;top: 20px;">
						<input name="loginPwd" class="form-control" type="password" placeholder="密码">
					</div>
...
<script>
	...
	/*$('button[type=button]').click(function () {
		$.post("/crm/settings/user/asyncLogin",{
			'loginAct' : $('input[name=loginAct]').val(),
